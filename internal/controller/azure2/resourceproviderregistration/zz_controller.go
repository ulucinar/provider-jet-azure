...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-jet-azure/apis/azure2/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	name := managed.ControllerName(v1alpha1.ResourceProviderRegistration_GroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.ResourceProviderRegistration_GroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.ResourceProviderRegistration{}).
		Complete(r)
}
