...
var (
	LighthouseAssignmentKind             = "LighthouseAssignment"
	LighthouseAssignmentGroupKind        = schema.GroupKind{Group: Group, Kind: LighthouseAssignmentKind}.String()
	LighthouseAssignmentKindAPIVersion   = LighthouseAssignmentKind + "." + GroupVersion.String()
	LighthouseAssignmentGroupVersionKind = GroupVersion.WithKind(LighthouseAssignmentKind)
)
