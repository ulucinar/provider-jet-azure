...
// MysqlConfiguration is the Schema for the MysqlConfigurations API
...
var (
	MysqlConfigurationKind             = "MysqlConfiguration"
	MysqlConfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: MysqlConfigurationKind}.String()
	MysqlConfigurationKindAPIVersion   = MysqlConfigurationKind + "." + GroupVersion.String()
	MysqlConfigurationGroupVersionKind = GroupVersion.WithKind(MysqlConfigurationKind)
)
