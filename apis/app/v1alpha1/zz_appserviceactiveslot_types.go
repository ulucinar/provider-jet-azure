...
// AppServiceActiveSlot is the Schema for the AppServiceActiveSlots API
...
var (
	AppServiceActiveSlotKind             = "AppServiceActiveSlot"
	AppServiceActiveSlotGroupKind        = schema.GroupKind{Group: Group, Kind: AppServiceActiveSlotKind}.String()
	AppServiceActiveSlotKindAPIVersion   = AppServiceActiveSlotKind + "." + GroupVersion.String()
	AppServiceActiveSlotGroupVersionKind = GroupVersion.WithKind(AppServiceActiveSlotKind)
)

func init() {
	SchemeBuilder.Register(&AppServiceActiveSlot{}, &AppServiceActiveSlotList{})
}
