...
var (
	ApplicationInsightsApiKeyKind             = "ApplicationInsightsApiKey"
	ApplicationInsightsApiKeyGroupKind        = schema.GroupKind{Group: Group, Kind: ApplicationInsightsApiKeyKind}.String()
	ApplicationInsightsApiKeyKindAPIVersion   = ApplicationInsightsApiKeyKind + "." + GroupVersion.String()
	ApplicationInsightsApiKeyGroupVersionKind = GroupVersion.WithKind(ApplicationInsightsApiKeyKind)
)
