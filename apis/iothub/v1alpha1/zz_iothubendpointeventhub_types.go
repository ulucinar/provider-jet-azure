...
var (
	IothubEndpointEventhubKind             = "IothubEndpointEventhub"
	IothubEndpointEventhubGroupKind        = schema.GroupKind{Group: Group, Kind: IothubEndpointEventhubKind}.String()
	IothubEndpointEventhubKindAPIVersion   = IothubEndpointEventhubKind + "." + GroupVersion.String()
	IothubEndpointEventhubGroupVersionKind = GroupVersion.WithKind(IothubEndpointEventhubKind)
)
