...
// IothubEndpointServicebusQueue is the Schema for the IothubEndpointServicebusQueues API
...
var (
	IothubEndpointServicebusQueueKind             = "IothubEndpointServicebusQueue"
	IothubEndpointServicebusQueueGroupKind        = schema.GroupKind{Group: Group, Kind: IothubEndpointServicebusQueueKind}.String()
	IothubEndpointServicebusQueueKindAPIVersion   = IothubEndpointServicebusQueueKind + "." + GroupVersion.String()
	IothubEndpointServicebusQueueGroupVersionKind = GroupVersion.WithKind(IothubEndpointServicebusQueueKind)
)
