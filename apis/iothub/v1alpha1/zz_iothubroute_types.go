...
var (
	IothubRouteKind             = "IothubRoute"
	IothubRouteGroupKind        = schema.GroupKind{Group: Group, Kind: IothubRouteKind}.String()
	IothubRouteKindAPIVersion   = IothubRouteKind + "." + GroupVersion.String()
	IothubRouteGroupVersionKind = GroupVersion.WithKind(IothubRouteKind)
)
