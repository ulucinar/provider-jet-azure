...
var (
	SubnetRouteTableAssociationKind             = "SubnetRouteTableAssociation"
	SubnetRouteTableAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: SubnetRouteTableAssociationKind}.String()
	SubnetRouteTableAssociationKindAPIVersion   = SubnetRouteTableAssociationKind + "." + GroupVersion.String()
	SubnetRouteTableAssociationGroupVersionKind = GroupVersion.WithKind(SubnetRouteTableAssociationKind)
)
