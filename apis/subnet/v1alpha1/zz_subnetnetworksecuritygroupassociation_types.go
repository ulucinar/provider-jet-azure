...
var (
	SubnetNetworkSecurityGroupAssociationKind             = "SubnetNetworkSecurityGroupAssociation"
	SubnetNetworkSecurityGroupAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: SubnetNetworkSecurityGroupAssociationKind}.String()
	SubnetNetworkSecurityGroupAssociationKindAPIVersion   = SubnetNetworkSecurityGroupAssociationKind + "." + GroupVersion.String()
	SubnetNetworkSecurityGroupAssociationGroupVersionKind = GroupVersion.WithKind(SubnetNetworkSecurityGroupAssociationKind)
)
