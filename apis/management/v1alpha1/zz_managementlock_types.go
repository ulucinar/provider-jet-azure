...
var (
	ManagementLockKind             = "ManagementLock"
	ManagementLockGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementLockKind}.String()
	ManagementLockKindAPIVersion   = ManagementLockKind + "." + GroupVersion.String()
	ManagementLockGroupVersionKind = GroupVersion.WithKind(ManagementLockKind)
)
