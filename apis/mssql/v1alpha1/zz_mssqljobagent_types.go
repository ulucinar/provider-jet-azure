...
var (
	MssqlJobAgentKind             = "MssqlJobAgent"
	MssqlJobAgentGroupKind        = schema.GroupKind{Group: Group, Kind: MssqlJobAgentKind}.String()
	MssqlJobAgentKindAPIVersion   = MssqlJobAgentKind + "." + GroupVersion.String()
	MssqlJobAgentGroupVersionKind = GroupVersion.WithKind(MssqlJobAgentKind)
)
