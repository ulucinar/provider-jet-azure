...
var (
	BackupProtectedVmKind             = "BackupProtectedVm"
	BackupProtectedVmGroupKind        = schema.GroupKind{Group: Group, Kind: BackupProtectedVmKind}.String()
	BackupProtectedVmKindAPIVersion   = BackupProtectedVmKind + "." + GroupVersion.String()
	BackupProtectedVmGroupVersionKind = GroupVersion.WithKind(BackupProtectedVmKind)
)
