...
var (
	SshPublicKeyKind             = "SshPublicKey"
	SshPublicKeyGroupKind        = schema.GroupKind{Group: Group, Kind: SshPublicKeyKind}.String()
	SshPublicKeyKindAPIVersion   = SshPublicKeyKind + "." + GroupVersion.String()
	SshPublicKeyGroupVersionKind = GroupVersion.WithKind(SshPublicKeyKind)
)
