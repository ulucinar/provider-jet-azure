...
var (
	ResourceProviderRegistrationKind             = "ResourceProviderRegistration"
	ResourceProviderRegistrationGroupKind        = schema.GroupKind{Group: Group, Kind: ResourceProviderRegistrationKind}.String()
	ResourceProviderRegistrationKindAPIVersion   = ResourceProviderRegistrationKind + "." + GroupVersion.String()
	ResourceProviderRegistrationGroupVersionKind = GroupVersion.WithKind(ResourceProviderRegistrationKind)
)
