...
// SiteRecoveryNetworkMapping is the Schema for the SiteRecoveryNetworkMappings API
...
var (
	SiteRecoveryNetworkMappingKind             = "SiteRecoveryNetworkMapping"
	SiteRecoveryNetworkMappingGroupKind        = schema.GroupKind{Group: Group, Kind: SiteRecoveryNetworkMappingKind}.String()
	SiteRecoveryNetworkMappingKindAPIVersion   = SiteRecoveryNetworkMappingKind + "." + GroupVersion.String()
	SiteRecoveryNetworkMappingGroupVersionKind = GroupVersion.WithKind(SiteRecoveryNetworkMappingKind)
)
