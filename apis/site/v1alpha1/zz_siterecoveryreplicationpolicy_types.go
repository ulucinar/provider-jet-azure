...
var (
	SiteRecoveryReplicationPolicyKind             = "SiteRecoveryReplicationPolicy"
	SiteRecoveryReplicationPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: SiteRecoveryReplicationPolicyKind}.String()
	SiteRecoveryReplicationPolicyKindAPIVersion   = SiteRecoveryReplicationPolicyKind + "." + GroupVersion.String()
	SiteRecoveryReplicationPolicyGroupVersionKind = GroupVersion.WithKind(SiteRecoveryReplicationPolicyKind)
)
