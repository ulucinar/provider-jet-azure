...
var (
	SentinelDataConnectorAzureSecurityCenterKind             = "SentinelDataConnectorAzureSecurityCenter"
	SentinelDataConnectorAzureSecurityCenterGroupKind        = schema.GroupKind{Group: Group, Kind: SentinelDataConnectorAzureSecurityCenterKind}.String()
	SentinelDataConnectorAzureSecurityCenterKindAPIVersion   = SentinelDataConnectorAzureSecurityCenterKind + "." + GroupVersion.String()
	SentinelDataConnectorAzureSecurityCenterGroupVersionKind = GroupVersion.WithKind(SentinelDataConnectorAzureSecurityCenterKind)
)
