...
var (
	LbBackendAddressPoolAddressKind             = "LbBackendAddressPoolAddress"
	LbBackendAddressPoolAddressGroupKind        = schema.GroupKind{Group: Group, Kind: LbBackendAddressPoolAddressKind}.String()
	LbBackendAddressPoolAddressKindAPIVersion   = LbBackendAddressPoolAddressKind + "." + GroupVersion.String()
	LbBackendAddressPoolAddressGroupVersionKind = GroupVersion.WithKind(LbBackendAddressPoolAddressKind)
)
