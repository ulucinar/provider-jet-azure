...
var (
	DnsPtrRecordKind             = "DnsPtrRecord"
	DnsPtrRecordGroupKind        = schema.GroupKind{Group: Group, Kind: DnsPtrRecordKind}.String()
	DnsPtrRecordKindAPIVersion   = DnsPtrRecordKind + "." + GroupVersion.String()
	DnsPtrRecordGroupVersionKind = GroupVersion.WithKind(DnsPtrRecordKind)
)
