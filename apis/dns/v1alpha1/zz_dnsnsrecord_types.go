...
var (
	DnsNsRecordKind             = "DnsNsRecord"
	DnsNsRecordGroupKind        = schema.GroupKind{Group: Group, Kind: DnsNsRecordKind}.String()
	DnsNsRecordKindAPIVersion   = DnsNsRecordKind + "." + GroupVersion.String()
	DnsNsRecordGroupVersionKind = GroupVersion.WithKind(DnsNsRecordKind)
)
