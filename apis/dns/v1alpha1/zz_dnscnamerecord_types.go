...
var (
	DnsCnameRecordKind             = "DnsCnameRecord"
	DnsCnameRecordGroupKind        = schema.GroupKind{Group: Group, Kind: DnsCnameRecordKind}.String()
	DnsCnameRecordKindAPIVersion   = DnsCnameRecordKind + "." + GroupVersion.String()
	DnsCnameRecordGroupVersionKind = GroupVersion.WithKind(DnsCnameRecordKind)
)
