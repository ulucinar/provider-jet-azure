...
// LogAnalyticsDatasourceWindowsEvent is the Schema for the LogAnalyticsDatasourceWindowsEvents API
...
var (
	LogAnalyticsDatasourceWindowsEventKind             = "LogAnalyticsDatasourceWindowsEvent"
	LogAnalyticsDatasourceWindowsEventGroupKind        = schema.GroupKind{Group: Group, Kind: LogAnalyticsDatasourceWindowsEventKind}.String()
	LogAnalyticsDatasourceWindowsEventKindAPIVersion   = LogAnalyticsDatasourceWindowsEventKind + "." + GroupVersion.String()
	LogAnalyticsDatasourceWindowsEventGroupVersionKind = GroupVersion.WithKind(LogAnalyticsDatasourceWindowsEventKind)
)
