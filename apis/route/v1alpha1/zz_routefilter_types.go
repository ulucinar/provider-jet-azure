...
type RuleParameters struct {
	...
	// +kubebuilder:validation:Required
	Communities []string `json:"communities" tf:"communities"`
...
// RouteFilter is the Schema for the RouteFilters API
...
var (
	RouteFilterKind             = "RouteFilter"
	RouteFilterGroupKind        = schema.GroupKind{Group: Group, Kind: RouteFilterKind}.String()
	RouteFilterKindAPIVersion   = RouteFilterKind + "." + GroupVersion.String()
	RouteFilterGroupVersionKind = GroupVersion.WithKind(RouteFilterKind)
)
