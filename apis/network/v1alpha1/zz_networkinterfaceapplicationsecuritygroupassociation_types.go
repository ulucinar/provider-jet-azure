...
var (
	NetworkInterfaceApplicationSecurityGroupAssociationKind             = "NetworkInterfaceApplicationSecurityGroupAssociation"
	NetworkInterfaceApplicationSecurityGroupAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkInterfaceApplicationSecurityGroupAssociationKind}.String()
	NetworkInterfaceApplicationSecurityGroupAssociationKindAPIVersion   = NetworkInterfaceApplicationSecurityGroupAssociationKind + "." + GroupVersion.String()
	NetworkInterfaceApplicationSecurityGroupAssociationGroupVersionKind = GroupVersion.WithKind(NetworkInterfaceApplicationSecurityGroupAssociationKind)
)
