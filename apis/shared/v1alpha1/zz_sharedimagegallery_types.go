...
var (
	SharedImageGalleryKind             = "SharedImageGallery"
	SharedImageGalleryGroupKind        = schema.GroupKind{Group: Group, Kind: SharedImageGalleryKind}.String()
	SharedImageGalleryKindAPIVersion   = SharedImageGalleryKind + "." + GroupVersion.String()
	SharedImageGalleryGroupVersionKind = GroupVersion.WithKind(SharedImageGalleryKind)
)
