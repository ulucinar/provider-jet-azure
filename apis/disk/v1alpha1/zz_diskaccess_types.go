...
var (
	DiskAccessKind             = "DiskAccess"
	DiskAccessGroupKind        = schema.GroupKind{Group: Group, Kind: DiskAccessKind}.String()
	DiskAccessKindAPIVersion   = DiskAccessKind + "." + GroupVersion.String()
	DiskAccessGroupVersionKind = GroupVersion.WithKind(DiskAccessKind)
)
