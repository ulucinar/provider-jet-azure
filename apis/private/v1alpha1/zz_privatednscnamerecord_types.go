...
var (
	PrivateDnsCnameRecordKind             = "PrivateDnsCnameRecord"
	PrivateDnsCnameRecordGroupKind        = schema.GroupKind{Group: Group, Kind: PrivateDnsCnameRecordKind}.String()
	PrivateDnsCnameRecordKindAPIVersion   = PrivateDnsCnameRecordKind + "." + GroupVersion.String()
	PrivateDnsCnameRecordGroupVersionKind = GroupVersion.WithKind(PrivateDnsCnameRecordKind)
)
