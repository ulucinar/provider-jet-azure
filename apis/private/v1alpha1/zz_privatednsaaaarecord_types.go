...
// PrivateDnsAaaaRecord is the Schema for the PrivateDnsAaaaRecords API
...
var (
	PrivateDnsAaaaRecordKind             = "PrivateDnsAaaaRecord"
	PrivateDnsAaaaRecordGroupKind        = schema.GroupKind{Group: Group, Kind: PrivateDnsAaaaRecordKind}.String()
	PrivateDnsAaaaRecordKindAPIVersion   = PrivateDnsAaaaRecordKind + "." + GroupVersion.String()
	PrivateDnsAaaaRecordGroupVersionKind = GroupVersion.WithKind(PrivateDnsAaaaRecordKind)
)
