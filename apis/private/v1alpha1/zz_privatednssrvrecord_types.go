...
type PrivateDnsSrvRecordParameters struct {
	...
	// +kubebuilder:validation:Required
	Record []PrivateDnsSrvRecordRecordParameters `json:"record" tf:"record"`
...
var (
	PrivateDnsSrvRecordKind             = "PrivateDnsSrvRecord"
	PrivateDnsSrvRecordGroupKind        = schema.GroupKind{Group: Group, Kind: PrivateDnsSrvRecordKind}.String()
	PrivateDnsSrvRecordKindAPIVersion   = PrivateDnsSrvRecordKind + "." + GroupVersion.String()
	PrivateDnsSrvRecordGroupVersionKind = GroupVersion.WithKind(PrivateDnsSrvRecordKind)
)
